			...
			<tr valign="top">
				...
				<td>
				   ...
				   <label ><input name="wb_general_tweak[<?php echo $this->option?>]" type="radio" value="" <?php echo ($this->value=="")?' checked="checked"':'';?>> No</label> 
					<br />
                                        <p><?php echo __( 'This function applies transformations of quotes to smart quotes, apostrophes, dashes, ellipses, the trademark symbol, and the multiplication symbol.', WB_CHANGE_EMAIL_SLUG )?>
					<?php echo sprintf( __( 'You can read information about this function <a href="%s" target="_blank">here</a>', WB_CHANGE_EMAIL_SLUG ), 'http://codex.wordpress.org/Function_Reference/wptexturize' );?></p>
				</td>
			</tr>
			<?php
		}
